...
In order to install the application download and run the MSI file from http://packages.diladele.com/webproxy/0.1.0.333B/amd64/release/windows/webproxy-0.1.0.333B_amd64.msi. 
